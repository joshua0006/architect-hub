...
const TaskTree: React.FC<TaskTreeProps> = ({ onTaskClick }) => {
  ...
  const task: Task = {
    ...
    description: 'Create a complete card layout design for the application',
    assignedTo: ['user-1'],
    ...
    subtasks: [
      {
        ...
        description: 'Create a more compact version of the card layout',
        assignedTo: ['user-1'],
        dueDate: new Date().toISOString(),
        priority: 'medium',
        status: 'todo',
      ...
      },
      {
        ...
        description: 'Modify the card component to hide the Add Subtask button',
        assignedTo: ['user-1'],
        dueDate: new Date().toISOString(),
        priority: 'low',
        status: 'todo',
...
const TaskTreeStandalone: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto">
        ...
        <p className="text-gray-600 mb-8 px-4">
          ...
          The parent task "Design a Card Layout" has two subtasks.
        </p>
...
export default TaskTreeStandalone; 